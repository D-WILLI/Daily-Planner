...
/*
The user will be shown an agenda will the current Day and Time 
    1. Preferably in the Format 
        Day of the Week, Month, Day , Hour , Minute 
** The User can click on a box next to time and will have the option to type in text 
The user clicks the add to calendar button 
The user can then save the information inside the text box 
    This will be stored in local storage 
The calendar calendar will show the following 
    1. A color for time that has passed 
    2. A color for current time 
    3. A color for upcoming times. */
